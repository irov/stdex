...
namespace stdex
{
    ...
    public:
        ...
        {
            const linked_type * head = &m_head;
            const linked_type * node = m_head.right_get();
            size_type count = stdex::helper::intrusive_slug_distance( node, head );
        ...
        inline bool empty() const
        {
            const linked_type * head = &m_head;
            const linked_type * node = m_head.right_get();
            bool empty = stdex::helper::intrusive_slug_empty( node, head );
